    ...
    <div className="space-y-6">
        ...
        <div className="space-y-3">
          <div>
            ...
            <textarea
              ...
              onChange={(e) => onUpdateObjectField("text", e.target.value)}
              onBlur={onFieldBlur}
            ...
            <div>
              ...
              <div className="flex items-center gap-1">
                ...
                <input
                  ...
                  onChange={(e) =>
                    onUpdateObjectField("fontSize", parseInt(e.target.value))
                  }
                  onBlur={onFieldBlur}
          ...
          <div>
            ...
            <div className="flex gap-1">
              <Button
                type="button"
                variant={
                  selectedObject.fontWeight === "bold" ? "default" : "outline"
                }
                size="sm"
                onClick={() => {
                  const newWeight =
              ...
              <Button
                type="button"
                variant={
                  selectedObject.fontStyle === "italic" ? "default" : "outline"
                }
                size="sm"
                onClick={() => {
                  const newStyle =
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-1">
              ...
              <Button
                ...
                onClick={() => {
                  const currentText = selectedObject.text || "";
                  const newText = currentText.replace(/\s+/g, " ").trim();
                  onUpdateObjectField("text", newText);
                  onFieldBlur();
                }}
                className="h-8 text-xs"
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="flex gap-1">
              ...
              <Button
                type="button"
                variant={
                  selectedObject.textAlign === "justify" ? "default" : "outline"
                }
                size="sm"
                onClick={() => {
          ...
          <div className="space-y-3">
            <RangeSlider
              ...
              onChange={(value) => onUpdateObjectField("letterSpacing", value)}
              onBlur={onFieldBlur}
              min={-5}
              max={20}
              step={0.5}
            ...
            <RangeSlider
              ...
              onChange={(value) => onUpdateObjectField("lineHeight", value)}
              onBlur={onFieldBlur}
              min={0.5}
              max={3}
              step={0.1}
            ...
            <RangeSlider
              ...
              onChange={(value) => onUpdateObjectField("wordSpacing", value)}
              onBlur={onFieldBlur}
              min={-5}
              max={20}
              step={0.5}
      ...
      <div>
        ...
        <div className="space-y-3 grid grid-cols-2 gap-3">
          <div>
            ...
            <div className="flex gap-2">
              <Button
                type="button"
                variant={
                  selectedObject.listType === "bullet" ? "default" : "outline"
                }
                size="sm"
                onClick={() => {
                  onUpdateObjectField(
              ...
              <Button
                type="button"
                variant={
                  selectedObject.listType === "number" ? "default" : "outline"
                }
                size="sm"
                onClick={() => {
                  onUpdateObjectField(
          ...
          {selectedObject.listType && selectedObject.listType !== "none" && (
            <div>
              <Label
                htmlFor="listStyle"
                className="text-xs font-medium text-gray-700 mb-1 block"
              ...
              <select
                ...
                value={
                  ...
                  (selectedObject.listType === "bullet" ? "disc" : "decimal")
                }
                onChange={(e) =>
